...
train_generator = generator(train_samples, batch_size=32, in_train=True)
validation_generator = generator(validation_samples, batch_size=32,
                                 in_train=True)

from keras.models import Sequential, Model
from keras.layers import Cropping2D, Convolution2D, Dense, Flatten, Lambda
...
model.fit_generator(train_generator, steps_per_epoch=len(train_samples)//32,
                    ...
                    validation_steps=len(validation_samples)//32, epochs=10,
